...
export const NOTICE_DATA = [
  {
    ...
    content: [
      "플로팅 채팅 기능 추가:",
      "  우하단 플로팅 버튼으로 전투 중에도 채팅 가능",
      "  채팅 탭이 아닐 때 자동으로 표시",
      "  읽지 않음 알림 배지 기능",
      "  항해/탐사/원정 등 모든 전투에서 채팅 가능",
      "항해 시스템 서버측 검증 강화:",
      "원정 전투 보안 강화:",
      "UI 개선:",
      "상단 메뉴탭 사이드바로 이동",
  ...
  },
  {
    ...
    content: [
      ...
      "수집도감에서 동료 상세정보 모달 추가",
      "버그 fix:",
      "에블린 돌파 문제 수정",
      "임포머스 별조각 3개 적용안되던 점 수정",
      "원정전투에서 엘리시아 스테이터스가 반영안되던 점 수정"
    ],
    isNew: false,
    type: "major_update"
  },
  {
    ...
    content: [
      ...
      "자동항해전투 기능 추가",
      "버그 fix:",
      "  클로에 스킬중 체력이 100%인 동료에게도 회복이 되던 점 수정",
  ...
  },
  {
    ...
    content: [
      "레이드 보상 상향:",
      "  폭주하는 해신 막타 보너스: 별조각 1개 → 2개",
      "  임포머스 막타 보너스: 별조각 1개 → 2개",
      "아이템 조합/분해시 필요 골드 절반으로 감소",
      "버그 수정:",
  ...
  },
  {
    id: 53,
    date: "2025.11.09",
    title: "[v1.415] ⚓ 항해전투 랭크 확장 및 난이도 하향",
    content: [
      "항해전투 물고기 추가:",
      "- rank 26-28 신규 물고기 3종 추가",
      "항해전투 밸런스 조정:",
      "- 전체 물고기 난이도 30% 하향",
      "  체력 30% 감소",
      "  공격력 30% 감소",
  ...
  },
  {
    id: 52,
    date: "2025.11.09",
    title: "[v1.415] ⚔️ 신규 영웅 동료 2명 추가",
    content: [
      "신규 영웅 동료 2명 추가:",
      "  • 리무 (호박석 100,000개)",
      "  • 셰리 (호박석 180,000개)",
      "전투 시스템 개선:",
      "  - 모든 전투(탐사/아레나/항해/원정)에 새 버프 시스템 적용",
      "  - 동료 버프 UI 개선",
      "수집도감에 동료 컬렉션 추가",
      "악세사리 기본체력 소폭 상향",
      "장비 강화시 호박석 소모량 증가",
      "버그 fix:",
      "  임포머스 소환타이머 작동 안되던 문제 수정",
      "  임포머스에서 동료 공격 애니메이션 렌더링 수정"
    ],
    isNew: false,
    type: "major_update"
  },
