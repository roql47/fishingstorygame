...
const SHOP_DATA = {
  fishing_rod: [
    { name: '낡은낚시대', material: 'gold', price: 7500, description: '오래된 낚시대입니다', requiredSkill: 0 },
    { name: '기본낚시대', material: 'gold', price: 25000, description: '기본적인 낚시대입니다', requiredSkill: 1 },
    { name: '단단한낚시대', material: 'gold', price: 60000, description: '견고한 낚시대입니다', requiredSkill: 2 },
    { name: '은낚시대', material: 'gold', price: 120000, description: '은으로 만든 고급 낚시대입니다', requiredSkill: 3 },
    { name: '금낚시대', material: 'gold', price: 225000, description: '금으로 만든 최고급 낚시대입니다', requiredSkill: 4 },
    { name: '강철낚시대', material: '백년송', materialCount: 10, description: '강철로 제련된 견고한 낚시대입니다', requiredSkill: 5 },
    { name: '사파이어낚시대', material: '후춧가루', materialCount: 15, description: '사파이어가 박힌 신비로운 낚시대입니다', requiredSkill: 6 },
    { name: '루비낚시대', material: '석화', materialCount: 20, description: '루비의 힘이 깃든 화려한 낚시대입니다', requiredSkill: 7 },
    { name: '다이아몬드낚시대', material: '핫소스', materialCount: 25, description: '다이아몬드의 광채가 빛나는 낚시대입니다', requiredSkill: 8 },
    { name: '레드다이아몬드낚시대', material: '펌킨조각', materialCount: 30, description: '희귀한 레드다이아몬드로 만든 전설적인 낚시대입니다', requiredSkill: 9 },
    { name: '벚꽃낚시대', material: '꽃술', materialCount: 35, description: '벚꽃의 아름다움을 담은 환상적인 낚시대입니다', requiredSkill: 10 },
    { name: '꽃망울낚시대', material: '프레첼', materialCount: 40, description: '꽃망울처럼 생긴 신비한 낚시대입니다', requiredSkill: 11 },
    { name: '호롱불낚시대', material: '베놈', materialCount: 45, description: '호롱불처럼 따뜻한 빛을 내는 낚시대입니다', requiredSkill: 12 },
    { name: '산호등낚시대', material: '장어꼬리', materialCount: 50, description: '바다 깊은 곳의 산호로 만든 낚시대입니다', requiredSkill: 13 },
    { name: '피크닉', material: '아인스바인', materialCount: 55, description: '즐거운 피크닉 분위기의 특별한 낚시대입니다', requiredSkill: 14 },
    { name: '마녀빗자루', material: '헤븐즈서펀트', materialCount: 60, description: '마녀의 마법이 깃든 신비로운 빗자루 낚시대입니다', requiredSkill: 15 },
    { name: '에테르낚시대', material: '집게다리', materialCount: 65, description: '에테르의 힘으로 만들어진 초월적인 낚시대입니다', requiredSkill: 16 },
    { name: '별조각낚시대', material: '이즈니버터', materialCount: 70, description: '별의 조각으로 만든 우주적인 낚시대입니다', requiredSkill: 17 },
    { name: '여우꼬리낚시대', material: '라벤더오일', materialCount: 75, description: '여우의 꼬리처럼 유연한 신비한 낚시대입니다', requiredSkill: 18 },
    { name: '초콜릿롤낚시대', material: '샤베트', materialCount: 80, description: '달콤한 초콜릿롤 모양의 귀여운 낚시대입니다', requiredSkill: 19 },
  ...
  accessories: [
    ...
    { name: '은목걸이', material: 'gold', price: 50000, description: '은으로 만든 아름다운 목걸이입니다', requiredSkill: 1 },
    { name: '금귀걸이', material: 'gold', price: 120000, description: '금으로 만든 화려한 귀걸이입니다', requiredSkill: 2 },
  ...
  items: [
    ...
    { name: '자동미끼', material: '별조각', materialCount: 1, count: 30, description: '낚시 쿨타임이 끝날 때마다 자동으로 낚시를 합니다 (30개 구매)', requiredSkill: 0 }
  ]
};
